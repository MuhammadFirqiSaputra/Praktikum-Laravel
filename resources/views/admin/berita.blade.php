    ...
    <div class="container">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item" style="margin-left: 30px">
                            <h5> <a class="nav-link active" aria-current="page"
                                    href="{{ route('admin.berita') }}">Berita</a> </h5>
                        </li>
                        <li class="nav-item" style="margin-left: 30px">
                            <h5>
        ...
        <div class="container mt-3">
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Berhasil!</strong> {{ Session::get('success') }} <button type="button" class="btn-close"
                    data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            @endif
            @if (Session::get('failed'))
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Gagal!</strong> {{ Session::get('failed') }} <button type="button" class="btn-close"
                    data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            @endif
        </div>
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        <img style="width: 50px" src="{{ asset('/images/' . $berita->gambar) }}" alt="cover berita">
                    </td>
