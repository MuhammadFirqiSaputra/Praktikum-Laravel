                    ...
                    <div class="col-6">
                        <form action="{{ route('admin.peminjaman') }}" method="GET">
                            ...
                            <div class="input-group">
                                <input type="search" name="search" class="formcontrol rounded" placeholder="Cari id peminjam" aria-label="Search" aria-describedby="searchaddon" />
                        ...
                        <tbody class="table-group-divider">
                            ...
                            @foreach ($data as $index => $peminjam)
                                <tr>
                                    ...
                                    <td>
                                        <span class="{{ $peminjam->status === 'Sudah Dikembalikan' ? 'fw-semibold text-success' : 'fw-semibold text-danger'}}"> {{ $peminjam->status }} </span>
                                    </td>
