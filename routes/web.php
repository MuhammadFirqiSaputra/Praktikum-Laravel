...
Route::get('/auth/profile', [LoginRegisterController::class, 'profile'])->name('auth.profile');
 Route::middleware(['guest'])->group (function () {
    ...
    Route::group(['middleware' => ['auth', 'checklevel:admin']], function () { 
        ...
        Route::get('/admin/detailPeminjaman/{id_peminjaman}/{id_buku}', [AdminController::class, 'detailPeminjaman'])->name('admin.detailPeminjaman');
    ...
    Route::group(['middleware' => ['auth', 'checklevel:user']], function () { 
        ...
        Route::get('profile', [LoginRegisterController::class, 'profile'])->name('profile');
        Route::get('/user/aktivitas', [LoginRegisterController::class, 'useraktivitas'])->name('user.aktivitas');
    });
    Route::get('/logout', [LoginRegisterController::class, 'logout'])->name('logout'); 
        Route::post('/postLogin', [LoginRegisterController::class, 'postLogin'])->name('postLogin'); 
        Route::post('/postRegister', [LoginRegisterController::class, 'postRegister'])->name('postRegister');
        ...
        Route::get('/views/berita', [AdminController::class, 'beritanew'])->name('views.berita');