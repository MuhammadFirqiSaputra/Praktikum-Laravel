...
class adminController extends Controller
{
    ...
    public function postTambahPeminjaman(Request $request) {
        ...
        if($peminjaman) {
            return back()->with('success', 'Data peminjaman berhasil ditambah!');
        } else {
    ...
    {
        $data = Berita::paginate(10); // Ubah angka 10 sesuai dengan jumlah data yang ingin ditampilkan per halaman
    ...
    {
        $berita = Berita::find($id);
        $berita->postEditBerita($request->all());
